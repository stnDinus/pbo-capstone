...
public class FrmTransaksi extends javax.swing.JFrame {
  ...
  /**
   * Setel jika tombol-tombol aktif berdasarkan jika pengguna sedang berinteraksi
   * dengan form
   *
   * @param t jika pengguna sedang berinteraksi dengan form
   */
  ...
  /**
   * Simpan rincian transaksi ke database
   */
  private void simpan_transaksi() {
    String sqlInsertJual = "INSERT INTO jual (no_jual, kd_kons, tgl_jual) VALUES (?, ?, ?)";
    String sqlInsertDjual = "INSERT INTO djual (no_jual, kd_brg, harga_jual, jml_jual, pajak) VALUES (?, ?, ?, ?, ?)";
  ...
  /** Inisialisasikan {@link tanggal} dengan tanggal terkini pengguna */
   ...
   *
   * @param isError jika pesan merupakan pesan error
  ...
  /**
   * Menyetel rincian barang yang terpilih.
   *
   * Digunakan oleh instansi {@link FrmSelectBarang} saat memilih barang
   */
  ...
  /** Menyetel {@link txtKembali} sesuai kembalian */
  ...
  private void initComponents() {
    ...
    layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
        new java.awt.Component[] { btnPilih, cmbKd_Brg, cmbKd_Kons, cmdBatal, cmdCetak, cmdHapusItem, cmdKeluar,
            ...
            txtId, txtJml, txtKembali, txtNama, txtNm_Brg, txtNoJual, txtPajak, txtTgl, txtTot, txtTotal });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtJml, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtTot, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmdHapusItem)
    ...
    layout.linkSize(javax.swing.SwingConstants.VERTICAL,
        new java.awt.Component[] { btnPilih, cmbKd_Brg, cmdBatal, cmdCetak, cmdHapusItem, cmdKeluar, cmdSimpan,
            cmdTambah, jLabel5, jLabel6, jLabel7, txtBayar, txtHarga, txtId, txtJml, txtKembali, txtNm_Brg, txtPajak,
            txtTot, txtTotal });
